...
const Share = () => {
	...
	return (
		<>
			<p>
				Here you can generate a link to this app with your current
				spoiler configuration.
			</p>
			<Form.Group inline>
				<label htmlFor={"share-spoiler-toggle"}>
					Deactivate spoiler configuration panel for people following
					your shared link.
				</label>
				<Form.Checkbox
			...
			{lockSpoilerPanel && (
				<Message negative>
					...
					Do not open the link yourself or you will not be able to
