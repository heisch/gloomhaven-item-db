...
const UploadForm = (props: Props) => {
  ...
  return (
    <>
      <p>
        Here you can generate a link to your account that others can export the
        data at any time.
      </p>
      <Form.Group>
        ...
        <Form.Button
          ...
          onClick={() => {
            (
              document.getElementById("export-url-input") as HTMLInputElement
            ).select();
      ...
      <Form.Group>
        ...
        {dataMismatch && (
          <p>
            Spoiler configuration differs from cloud storage. Remember to export
            your data.
          </p>
        )}
      </Form.Group>
