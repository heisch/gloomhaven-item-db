...
import { ClassesInUse, fcClassList, ghClassList, ItemManagementType, jotlClassList } from "../../../State/Types";
...
export const PartySpoiler = () => {
    ...
    const { filterOptions: { classesInUse, itemManagementType}, updateFilterOptions} = useFilterOptions();
    ...
    return <Form.Group inline className={'inline-break'}>
                ...
                <ClassList classes={ghClassList} label="Gloomhaven:" onClick={toggleClassFilter} isEnabled={(className: ClassesInUse) => classesInUse.includes(className)} />
